...
export const metadata: Metadata = {
  title: "KaushalLoop: verified learner readiness",
  description:
    ...
    <div className="mx-auto w-full max-w-6xl px-4 md:px-6">
      ...
      <section className="relative isolate overflow-hidden">
        ...
        <div>
          ...
          <p className="mt-4 max-w-md text-lg text-muted-foreground">
            KaushalLoop shows a college which employer skills its cohort is missing, which intervention closes them, and whether it worked.
          </p>
      ...
      <section className="grid items-center gap-10 py-20 md:grid-cols-2">
        <div>
          ...
          <p className="mt-3 text-muted-foreground">
            Not a course catalogue. KaushalLoop ranks programmes by the priority gaps they close, the time they take, and what a learner can prove afterwards, then projects the coverage before you commit hours.
          </p>
