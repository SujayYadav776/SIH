  ...
  return (
    <div className="mx-auto w-full max-w-5xl px-4 py-16 md:px-6 md:py-20">
      <div className="max-w-2xl">
        ...
        <p className="mt-4 text-lg text-muted-foreground">An employability system has to earn trust from students, placement officers and leadership. This is how KaushalLoop is bounded.</p>
      </div>
